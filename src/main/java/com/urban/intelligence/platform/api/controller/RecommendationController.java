...
public class RecommendationController {
    ...
    public ResponseEntity<Page<RecommendationResponse>> getRecommendationsByDistrict(
    ...
    public ResponseEntity<Page<RecommendationResponse>> getRecommendationsByPriority(
    ...
    public ResponseEntity<List<RecommendationResponse>> getUrgentRecommendations(@PathVariable Long districtId) {
